...
//  YUIKit
//
//  Created by YUI Team on 2018/8/14.
//
...
@interface YUIPropertyDescriptor : NSObject
...
OverrideImplementation(Class targetClass, SEL targetSelector, id (^implementationBlock)(__unsafe_unretained Class originClass, SEL originCMD, IMP (^originalIMPProvider)(void))) {
    ...
    IMP (^originalIMPProvider)(void) = ^IMP(void) {
        ...
        if (hasOverride) {
            ...
            // https://github.com/Tencent/YUI_iOS/issues/776
    ...
    if (hasOverride) {
        ...
        const char *typeEncoding = method_getTypeEncoding(originMethod) ?: [targetClass instanceMethodSignatureForSelector:targetSelector].yui_typeEncoding;
 ...
 */
#define _YUITypeEncodingDetectorGenerator(_TypeInFunctionName, _typeForEncode) \
...
_YUITypeEncodingDetectorGenerator(Char, char)
_YUITypeEncodingDetectorGenerator(Int, int)
_YUITypeEncodingDetectorGenerator(Short, short)
_YUITypeEncodingDetectorGenerator(Long, long)
_YUITypeEncodingDetectorGenerator(LongLong, long long)
_YUITypeEncodingDetectorGenerator(NSInteger, NSInteger)
_YUITypeEncodingDetectorGenerator(UnsignedChar, unsigned char)
_YUITypeEncodingDetectorGenerator(UnsignedInt, unsigned int)
_YUITypeEncodingDetectorGenerator(UnsignedShort, unsigned short)
_YUITypeEncodingDetectorGenerator(UnsignedLong, unsigned long)
_YUITypeEncodingDetectorGenerator(UnsignedLongLong, unsigned long long)
_YUITypeEncodingDetectorGenerator(NSUInteger, NSUInteger)
_YUITypeEncodingDetectorGenerator(Float, float)
_YUITypeEncodingDetectorGenerator(Double, double)
_YUITypeEncodingDetectorGenerator(CGFloat, CGFloat)
_YUITypeEncodingDetectorGenerator(BOOL, BOOL)
_YUITypeEncodingDetectorGenerator(Void, void)
_YUITypeEncodingDetectorGenerator(Character, char *)
_YUITypeEncodingDetectorGenerator(Object, id)
_YUITypeEncodingDetectorGenerator(Class, Class)
_YUITypeEncodingDetectorGenerator(Selector, SEL)
...
#define _YUIGetIvarValueGenerator(_TypeInFunctionName, _typeForEncode) \
...
_YUIGetIvarValueGenerator(Char, char)
_YUIGetIvarValueGenerator(Int, int)
_YUIGetIvarValueGenerator(Short, short)
_YUIGetIvarValueGenerator(Long, long)
_YUIGetIvarValueGenerator(LongLong, long long)
_YUIGetIvarValueGenerator(UnsignedChar, unsigned char)
_YUIGetIvarValueGenerator(UnsignedInt, unsigned int)
_YUIGetIvarValueGenerator(UnsignedShort, unsigned short)
_YUIGetIvarValueGenerator(UnsignedLong, unsigned long)
_YUIGetIvarValueGenerator(UnsignedLongLong, unsigned long long)
_YUIGetIvarValueGenerator(Float, float)
_YUIGetIvarValueGenerator(Double, double)
_YUIGetIvarValueGenerator(BOOL, BOOL)
_YUIGetIvarValueGenerator(Character, char *)
_YUIGetIvarValueGenerator(Selector, SEL)
...
/**
 ...
 int count = yui_getProjectClassList(&classes);
 Class class = (__bridge Class)classes[0];
 @endcode
 */
FOUNDATION_EXPORT int yui_getProjectClassList(classref_t **classes);
/**
 检测是否存在某个dyld  image
 */
FOUNDATION_EXPORT BOOL yui_exists_dyld_image(const char *target_image_name);
